...
const ALL_NEWS = [
  { tag:'Industry', date:'10 March 2026', title:'IndiGo Announces 500 First Officer Vacancies for 2026–27', excerpt:'India\'s largest carrier opens one of its biggest recruitment drives in five years, with positions across its A320 and ATR fleets.', source:'Aviation Week', slug:'indigo-500-fo-2026' },
  { tag:'DGCA', date:'4 March 2026', title:'DGCA Updates CPL Medical Standards — New AME Circular Effective April 2026', excerpt:'The DGCA has issued revised Class 2 medical examination guidelines effective April 1, 2026. Key changes for pilot training applicants.', source:'DGCA India', slug:'dgca-medical-circular-april-2026' },
  { tag:'Global Aviation', date:'28 Feb 2026', title:'IATA Forecasts India to Become World\'s Third Largest Aviation Market by 2030', excerpt:'IATA revises its India forecast upward, citing rapid fleet expansion, new route launches, and growing domestic passenger demand.', source:'IATA', slug:'iata-india-third-largest-2030' },
  { tag:'Airline', date:'20 Feb 2026', title:'Air India Expands Fleet by 40 Aircraft — Recruitment Push Expected in Q3 2026', excerpt:'Air India confirms delivery schedule for 40 new narrowbody aircraft, signalling significant recruitment activity for pilots and cabin crew.', source:'The Hindu Business', slug:'air-india-fleet-expansion-2026' },
  { tag:'DGCA', date:'15 Feb 2026', title:'DGCA Increases FBS Simulator Hours Acceptance for CPL Applicants', excerpt:'Under a new amendment, up to 40 hours of approved FBS simulator time can now be counted toward the total flight time requirement for CPL issuance.', source:'DGCA India', slug:'dgca-fbs-hours-increase-cpl' },
  ...
  { tag:'DGCA', date:'18 Jan 2026', title:'DGCA Issues Advisory on CPL Knowledge Test Scheduling — New Portal Launch', excerpt:'DGCA launches an updated online portal for CPL ground examination scheduling, replacing the legacy system. Changes effective February 2026.', source:'DGCA India', slug:'dgca-cpl-test-portal-launch' },
  { tag:'Airline', date:'10 Jan 2026', title:'Akasa Air Expands to 8 New Cities — Pilot Hiring Programme Announced', excerpt:'India\'s newest airline Akasa Air continues rapid network expansion with fresh recruitment for Boeing 737 MAX first officers.', source:'Aviation Week', slug:'akasa-air-8-cities-pilot-hiring' },
