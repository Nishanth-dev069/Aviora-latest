...
const ALL_POSTS = [
  ...
  { tag:'DGCA Exams', date:'December 2025', title:'Air Navigation for DGCA CPL — The Complete Study Breakdown', excerpt:'The subject with the highest failure rate. Charts, VOR/NDB, dead reckoning, flight planning — how to approach every topic systematically and pass first attempt.', readTime:'14 min', slug:'dgca-air-navigation-cpl-study-guide' },
  { tag:'Industry', date:'December 2025', title:'India\'s Aviation Boom — What It Means for Pilot and Cabin Crew Careers in 2026–31', excerpt:'Fleet expansion, new routes, and 10,000 pilots needed by 2030. The numbers behind India\'s aviation growth and what it means for you if you start training today.', readTime:'10 min', slug:'india-aviation-boom-careers-2026-2030' },
  { tag:'Medical', date:'November 2025', title:'DGCA Class 2 Medical — What to Expect and How to Prepare', excerpt:'The full Class 2 medical examination explained: vision, hearing, cardiovascular, ENT. What disqualifies you, what doesn\'t, and how to find an approved AME.', readTime:'8 min', slug:'dgca-class-2-medical-guide' },
  { tag:'Career Guide', date:'November 2025', title:'First Officer to Captain — The Career Progression Timeline for Indian Pilots', excerpt:'How long does it take? What does it cost? How many hours? The realistic progression from CPL to command, with actual timelines from Indian airline first officers.', readTime:'11 min', slug:'first-officer-to-captain-career-timeline' },
