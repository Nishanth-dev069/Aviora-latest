    ...
    collections: [
      // ───────────────────────────────────────── BLOG
      {
        ...
        fields: [
          ...
          { type: "string", name: "tag", label: "Category Tag", required: true,
          ...
          { type: "image", name: "img", label: "Cover Image" },
      ...
      // ───────────────────────────────────────── GALLERY
      {
        ...
        fields: [
          ...
          { type: "string", name: "cat", label: "Category", required: true,
            options: ["Training", "Cockpit", "USA Training", "In-flight", "Cabin Crew", "Operations", "Industry", "Student Life", "Facility", "All"] },
